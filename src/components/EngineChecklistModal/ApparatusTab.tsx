...
const twoOptionColors: Record<string, { bg: string; border: string; color: string }> = {
  Operational: { bg: "rgba(34,197,94,0.15)", border: "rgba(34,197,94,0.5)", color: "#22c55e" },
  Faulty:      { bg: "rgba(239,68,68,0.15)", border: "rgba(239,68,68,0.5)", color: "#ef4444" },
};

const batteryColors: Record<string, { bg: string; border: string; color: string }> = {
  Good: { bg: "rgba(34,197,94,0.15)",  border: "rgba(34,197,94,0.5)",  color: "#22c55e" },
  Weak: { bg: "rgba(245,158,11,0.15)", border: "rgba(245,158,11,0.5)", color: "#f59e0b" },
  Dead: { bg: "rgba(239,68,68,0.15)",  border: "rgba(239,68,68,0.5)",  color: "#ef4444" },
};

interface ApparatusTabProps {
  checks: ApparatusChecks;
  onChange: <K extends keyof ApparatusChecks>(key: K, value: ApparatusChecks[K]) => void;
}
